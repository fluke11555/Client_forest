...
import {Nature, Star} from '@material-ui/icons';
import "./app.css";
...
function App() {
  ...
  const [viewport, setViewport] = useState({
    width: "100w",
    height: "100vh",
    latitude: 18.808034681917768,
    longitude: 99.07912787577341,
    zoom: 4,
  });
...
const handleLogout= ()=>{
  ...
  return (
    ...
    <ReactMapGL
      ...
      mapStyle="mapbox://styles/flut001400/ckrre6ue91oda18mns4y9z9fv"
...
<>
      <Marker 
       ...
       >
      <Nature 
      style={{fontSize:viewport.zoom*5, color: "green", cursor:"pointer"}}
